...
--
-- Table structure for table `arrows_has_projects`
--

DROP TABLE IF EXISTS `arrows_has_projects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `arrows_has_projects` (
  `idArrowsHasProjects` int(11) NOT NULL AUTO_INCREMENT,
  `Arrows_idArrows` int(11) NOT NULL,
  `Projects_idProjects` int(11) NOT NULL,
  `idActivityBegin` int(11) DEFAULT NULL,
  `idActivityEnd` int(11) DEFAULT NULL,
  `idActivityBeginSide` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `arrows_has_projects`
--

LOCK TABLES `arrows_has_projects` WRITE;
/*!40000 ALTER TABLE `arrows_has_projects` DISABLE KEYS */;
/*!40000 ALTER TABLE `arrows_has_projects` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2012-07-04 11:11:06
