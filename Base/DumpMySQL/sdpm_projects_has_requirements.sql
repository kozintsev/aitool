...
--
-- Table structure for table `projects_has_requirements`
--

DROP TABLE IF EXISTS `projects_has_requirements`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projects_has_requirements` (
  `idProjectsHasRequirements` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `projects_has_requirements`
--

LOCK TABLES `projects_has_requirements` WRITE;
/*!40000 ALTER TABLE `projects_has_requirements` DISABLE KEYS */;
/*!40000 ALTER TABLE `projects_has_requirements` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2012-07-05 10:00:31
