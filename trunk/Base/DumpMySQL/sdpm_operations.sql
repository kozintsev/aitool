...
CREATE TABLE `operations` (
  ...
  `OperationDescription` varchar(255) DEFAULT NULL,
  `OperationKompas` varchar(45) DEFAULT NULL,
  `OperationOpenCASCADE` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2012-07-04 15:57:22
